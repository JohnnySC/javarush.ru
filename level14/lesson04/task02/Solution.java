...
public class Solution
{
    ...
    static class CatFactory //this is a parent class
    {
        static public Cat getCatByKey(String key)// this is a method, get string and return Cat
        {
            Cat cat = null;              //creating new Cat
            if ("vaska".equals(key))
            {
