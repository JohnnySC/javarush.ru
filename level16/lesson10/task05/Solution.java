...
public class Solution {
    ...
    public static class Water implements Runnable {
        ...
        public void run() {
            ...
            boolean isCurrentThreadInterrupted = Thread.currentThread().isInterrupted();//have to be fixed
            String threadName = Thread.currentThread().getName();//seems to be right
